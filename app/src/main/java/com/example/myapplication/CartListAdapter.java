...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.MyViewHolder> {
    ...
    public CartListAdapter(Context context, ArrayList<Book> list) {
    ...
    public void openActivity2(CartListAdapter.MyViewHolder holder) {
...
//        holder.bookPrice.setText(book.getBookPrice());
    ...
    public void addToFav(CartListAdapter.MyViewHolder holder) {
        String timestamp =String.valueOf( System.currentTimeMillis());
